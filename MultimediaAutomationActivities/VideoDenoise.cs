...
{
    public class VideoDenoise : CodeActivity
    {
        [Category("Input")]
        [RequiredArgument]
        ...
        [DefaultValue("-vf fftdnoiz=30:1:6:0.5:1:1 -vcodec prores_ks -profile:v 3")]
        [Category("Input")]
        public InArgument<String> Command { get; set; } = "-vf fftdnoiz=30:1:6:0.5:1:1 -vcodec prores_ks -profile:v 3";
        ...
        /// </summary>
        /// <param name="input">input is the stream we arde to return as a byte array</param>
        ...
        public void Execute()
        {
            ...
            var command = "-vf fftdnoiz=30:1:6:0.5:1:1";  //PNG To JPG
