...
namespace MultimediaAutomationActivities
{
    ...
    public class VideoDeliveryCodec : CodeActivity
    {
        ...
        [DefaultValue("-c:v libx264 -preset slower -crf 20 -c:a libfdk_aac -vbr 4 -ac 2 -movflags +faststart")]
        [Category("Input")]
        public InArgument<String> Command { get; set; } = "-c:v libx264 -preset slower -crf 20 -c:a libfdk_aac -vbr 4 -ac 2 -movflags +faststart";
        ...
        public void Execute()
        {
            ...
            var command = "-c:v libx264 -preset slower -crf 20 -c:a libfdk_aac -vbr 4 -ac 2 -movflags +faststart";  //PNG To JPG
